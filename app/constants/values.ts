...
export const VALUES: Benefit[] = [
  {
    ...
    title: 'Hormat pada Keputusan Jamaah',
    description: 'Kami percaya keputusan perjalanan spiritual sepenuhnya milik Anda. Peran kami adalah membantu, bukan menentukan.',
  },
  {
    icon: 'lucide:eye',
