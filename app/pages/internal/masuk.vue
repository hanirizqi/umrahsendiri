...
useSeoMeta({
  title: 'Masuk — Panel Internal UmrahSendiri',
...
async function submit() {
  ...
  try {
    ...
    // Hanya terima path internal, supaya parameter ini tidak bisa dipakai
    // mengalihkan ke situs lain.
    const tujuan = lanjut.startsWith('/internal/') ? lanjut : '/internal/kalkulator-harga'
    ...
    error.value = status === 429
      ...
      : status === 503
        ? 'Panel internal belum dikonfigurasi. Hubungi pengelola sistem.'
